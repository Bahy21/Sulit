...
class _$_HomeModel extends _HomeModel {
  ...
  @override
  String toString() {
    return 'HomeModel(sliders: $sliders, bannersOne: $bannersOne, bannersTwo: $bannersTwo, categories: $categories, mostPopular: $mostPopular, bestSellingProducts: $bestSellingProducts, newestProducts: $newestProducts, featuredProducts: $featuredProducts, topCategories: $topCategories, topBrands: $topBrands)';
  }
