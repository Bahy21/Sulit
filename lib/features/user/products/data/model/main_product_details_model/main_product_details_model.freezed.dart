...
mixin _$MainProductDetailsModel {
  ...
  List<ProductDetailsModel> get relatedProducts =>
      throw _privateConstructorUsedError;
  @JsonKey(name: 'top_products')
  List<ProductDetailsModel> get topProducts =>
      throw _privateConstructorUsedError;
...
abstract class $MainProductDetailsModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'product') ProductDetailsModel product,
      @JsonKey(name: 'related_products')
      List<ProductDetailsModel> relatedProducts,
      @JsonKey(name: 'top_products') List<ProductDetailsModel> topProducts,
...
class _$_MainProductDetailsModel extends _MainProductDetailsModel {
  const _$_MainProductDetailsModel(
      ...
      @JsonKey(name: 'related_products')
      required final List<ProductDetailsModel> relatedProducts,
      @JsonKey(name: 'top_products')
      required final List<ProductDetailsModel> topProducts,
  ...
  final List<ProductDetailsModel> _relatedProducts;
  @override
  @JsonKey(name: 'related_products')
  List<ProductDetailsModel> get relatedProducts {
  ...
  final List<ProductDetailsModel> _topProducts;
  @override
  @JsonKey(name: 'top_products')
  List<ProductDetailsModel> get topProducts {
...
abstract class _MainProductDetailsModel extends MainProductDetailsModel {
  const factory _MainProductDetailsModel(
          {@JsonKey(name: 'product') required final ProductDetailsModel product,
          @JsonKey(name: 'related_products')
          required final List<ProductDetailsModel> relatedProducts,
          @JsonKey(name: 'top_products')
          required final List<ProductDetailsModel> topProducts,
