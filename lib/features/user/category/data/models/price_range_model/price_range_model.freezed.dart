...
abstract class $PriceRangeModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'min') String min, @JsonKey(name: 'max') String max});
}
...
class _$_PriceRangeModel extends _PriceRangeModel {
  const _$_PriceRangeModel(
...
abstract class _PriceRangeModel extends PriceRangeModel {
  const factory _PriceRangeModel(
      {@JsonKey(name: 'min') required final String min,
      @JsonKey(name: 'max') required final String max}) = _$_PriceRangeModel;
  const _PriceRangeModel._() : super._();
