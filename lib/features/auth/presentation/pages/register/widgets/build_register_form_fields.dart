...
class BuildRegisterFormFields extends StatelessWidget {
  ...
  const BuildRegisterFormFields({Key? key, required this.registerController}) : super(key: key);
              ...
              builder: (context, state) {
                return  GenericTextField(
                  ...
                  suffixIcon: IconButton(
                    onPressed: () =>
                        registerController.passwordCubit.onUpdateData(!state.data),
                    icon: Icon(
          ...
          BlocBuilder<GenericBloc<bool>,GenericState<bool>>(
              ...
              builder: (context, state) {
                return  GenericTextField(
                  ...
                  suffixIcon: IconButton(
                    onPressed: () =>
                        registerController.confirmpasswordCubit.onUpdateData(!state.data),
                    icon: Icon(
                      !state.data ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                      size: 20.sp,
                      color: context.colors.primary,
