...
class BuildTicketsList extends StatelessWidget {
  ...
  const BuildTicketsList({Key? key, required this.supportTicketsController}) : super(key: key);
        ...
        ...List.generate(1, (index) =>Column(
          children: [
            Container(
                ...
                child: ListTile(
                  onTap: ()=>supportTicketsController.isVisibleCubit.onUpdateData(!state.data),
                  title: Text(
                    "test ticket",
