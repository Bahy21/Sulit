...
class _$_DropDownModel extends _DropDownModel {
  const _$_DropDownModel({required this.id, required this.name}) : super._();
...
abstract class _DropDownModel extends DropDownModel {
  const factory _DropDownModel(
      {required final int id, required final String name}) = _$_DropDownModel;
