      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text("File Info",style: AppTextStyle.s16_w500(color: context.colors.black),),
          ...
          BuildFileDetailsCustomItem(header: "File Name",content: "tequirowijfdfrtyuiytryutyyutityutyrutitslkjavbksdbvklabdva",),
          BuildFileDetailsCustomItem(header: "File Type",content: "document",),
          BuildFileDetailsCustomItem(header: "File Size",content: "29.99 KB",),
          BuildFileDetailsCustomItem(header: "Uploaded At",content: "122/12/2033",),
          DefaultButton(
              title: "Download ",
              width: 120.w,
              height: 25.h,
