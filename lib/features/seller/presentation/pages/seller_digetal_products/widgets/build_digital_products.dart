...
class BuildDigitalProducts extends StatelessWidget {
  ...
  const BuildDigitalProducts({Key? key, required this.sellerDigitalProductsController}) : super(key: key);
          ...
          ...List.generate(2, (index) => BlocBuilder<GenericBloc<bool>, GenericState<bool>>(
            ...
            builder: (context, state) {
              return Column(
                children: [
                  InkWell(
                    onTap: ()=>sellerDigitalProductsController.isVisible.onUpdateData(!state.data),
                    child: Container(
                  ...
                  Visibility(
                    ...
                    child: Container(
                        ...
                        child: Column(children: [
                          ...
                          Divider(color: context.colors.greyWhite,height: 30.h,),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
