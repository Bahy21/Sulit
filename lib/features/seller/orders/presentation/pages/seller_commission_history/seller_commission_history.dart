...
class SellerCommissionHistory extends StatefulWidget {
  ...
  @override
  State<SellerCommissionHistory> createState() =>
      _SellerCommissionHistoryState();
}

class _SellerCommissionHistoryState extends State<SellerCommissionHistory> {
  SellerCommissionHistoryController sellerCommissionHistoryController =
          ...
          Flexible(
            child: ListView.builder(
                ...
                itemBuilder: (context, index) =>
                    const BuildCommissionHistoryItem()),
          ),
        ],
      ),
    );
