...
import 'package:flutter_tdd/core/helpers/firebase_analytics_helper.dart'
    as _i30;
import 'package:flutter_tdd/core/helpers/global_context.dart' as _i33;
import 'package:flutter_tdd/core/helpers/global_notification.dart' as _i34;
import 'package:flutter_tdd/core/helpers/loading_helper.dart' as _i38;
import 'package:flutter_tdd/core/helpers/new_version_helper.dart' as _i40;
import 'package:flutter_tdd/core/helpers/rate_app_helper.dart' as _i58;
import 'package:flutter_tdd/core/helpers/utilities.dart' as _i71;
import 'package:flutter_tdd/core/http/dio_helper/actions/delete.dart' as _i27;
import 'package:flutter_tdd/core/http/dio_helper/actions/get.dart' as _i32;
import 'package:flutter_tdd/core/http/dio_helper/actions/patch.dart' as _i45;
import 'package:flutter_tdd/core/http/dio_helper/actions/post.dart' as _i46;
import 'package:flutter_tdd/core/http/dio_helper/actions/put.dart' as _i57;
import 'package:flutter_tdd/core/http/dio_helper/utils/dio_header.dart' as _i28;
...
import 'package:flutter_tdd/core/http/dio_helper/utils/handle_request_body.dart'
    as _i37;
import 'package:flutter_tdd/core/http/generic_http/generic_http.dart' as _i31;
import 'package:flutter_tdd/core/network/network_info.dart' as _i39;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i9.AuthRepository>(() => _i10.ImplAuthRepository());
    gh.factory<_i11.BaseDataSources>(() => _i12.ImplBaseDataSources());
    gh.factory<_i13.BaseRepository>(() => _i14.ImplBaseRepository());
    gh.factory<_i15.CartDataSources>(() => _i16.ImplCartDataSources());
    gh.factory<_i17.CartRepository>(() => _i18.ImplCartRepository());
    gh.factory<_i19.CategoryDataSources>(() => _i20.ImplCategoryDataSources());
    gh.factory<_i21.CategoryRepository>(() => _i22.ImplCategoryRepository());
    gh.factory<_i23.DashboardDataSources>(
        () => _i24.ImplDashboardDataSources());
    gh.factory<_i25.DashboardRepository>(() => _i26.ImplDashboardRepository());
    gh.lazySingleton<_i27.Delete>(() => _i27.Delete());
    gh.lazySingleton<_i28.DioHeader>(() => _i28.DioHeader());
    gh.lazySingleton<_i29.DioOptions>(() => _i29.DioOptions());
    gh.lazySingleton<_i30.FirebaseAnalyticsHelper>(
        () => _i30.FirebaseAnalyticsHelper());
    gh.lazySingleton<_i31.GenericHttpImpl<dynamic>>(
        () => _i31.GenericHttpImpl<dynamic>());
    gh.lazySingleton<_i32.Get>(() => _i32.Get());
    gh.lazySingleton<_i33.GlobalContext>(() => _i33.GlobalContext());
    gh.lazySingleton<_i34.GlobalNotification>(() => _i34.GlobalNotification());
    gh.lazySingleton<_i35.HandleErrors>(() => _i35.HandleErrors());
    gh.lazySingleton<_i36.HandleJsonResponse<dynamic>>(
        () => _i36.HandleJsonResponse<dynamic>());
    gh.lazySingleton<_i37.HandleRequestBody>(() => _i37.HandleRequestBody());
    gh.lazySingleton<_i38.LoadingHelper>(() => _i38.LoadingHelper());
    gh.lazySingleton<_i39.NetworkInfoImpl>(() => _i39.NetworkInfoImpl());
    gh.lazySingleton<_i40.NewVersionHelper>(() => _i40.NewVersionHelper());
    gh.factory<_i41.NotificationsDataSources>(
        () => _i42.ImplNotificationsDataSources());
    gh.factory<_i43.NotificationsRepository>(
        () => _i44.ImplNotificationsRepository());
    gh.lazySingleton<_i45.Patch>(() => _i45.Patch());
    gh.lazySingleton<_i46.Post>(() => _i46.Post());
    gh.factory<_i47.ProductsDataSource>(() => _i48.ImplProductsDataSource());
    gh.factory<_i49.ProductsRepository>(() => _i50.ImplProductsRepository());
    gh.factory<_i51.ProfileDataSources>(() => _i52.ImplProfileDataSources());
    gh.factory<_i53.PurchasingDataSources>(
        () => _i54.ImplPurchasingDataSources());
    gh.factory<_i55.PurchasingRepository>(
        () => _i56.ImplPurchasingRepository());
    gh.lazySingleton<_i57.Put>(() => _i57.Put());
    gh.lazySingleton<_i58.RateAppHelper>(() => _i58.RateAppHelper());
    gh.factory<_i59.SaleDataSources>(() => _i60.ImplSaleRepository());
    gh.factory<_i61.SaleRepository>(() => _i62.ImplSaleRepository());
    gh.factory<_i63.SearchDataSources>(() => _i64.ImplSearchDataSources());
    gh.factory<_i65.SearchRepository>(() => _i66.ImplSearchRepository());
    gh.factory<_i67.TicketsDataSources>(() => _i68.ImplTicketsDataSources());
    gh.factory<_i69.TicketsRepository>(() => _i70.ImplTicketsRepository());
    gh.lazySingleton<_i71.Utilities>(() => _i71.Utilities());
    gh.factory<_i72.WalletDataSources>(() => _i73.ImplWalletDataSources());
    gh.factory<_i74.WalletRepository>(() => _i75.ImplWalletRepository());
    gh.factory<_i76.WishlistDataSources>(() => _i77.ImplWishlistDataSources());
    gh.factory<_i78.WishlistRepository>(() => _i79.ImplWishlistRepository());
    return this;
  }
}
