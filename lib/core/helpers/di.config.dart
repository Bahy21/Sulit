...
import 'package:flutter_tdd/core/helpers/firebase_analytics_helper.dart'
    as _i40;
import 'package:flutter_tdd/core/helpers/get_device_id.dart' as _i43;
import 'package:flutter_tdd/core/helpers/global_context.dart' as _i44;
import 'package:flutter_tdd/core/helpers/global_notification.dart' as _i45;
import 'package:flutter_tdd/core/helpers/loading_helper.dart' as _i49;
import 'package:flutter_tdd/core/helpers/new_version_helper.dart' as _i51;
import 'package:flutter_tdd/core/helpers/rate_app_helper.dart' as _i72;
import 'package:flutter_tdd/core/helpers/utilities.dart' as _i85;
import 'package:flutter_tdd/core/http/dio_helper/actions/delete.dart' as _i36;
import 'package:flutter_tdd/core/http/dio_helper/actions/download.dart' as _i39;
import 'package:flutter_tdd/core/http/dio_helper/actions/get.dart' as _i42;
import 'package:flutter_tdd/core/http/dio_helper/actions/patch.dart' as _i56;
import 'package:flutter_tdd/core/http/dio_helper/actions/post.dart' as _i57;
import 'package:flutter_tdd/core/http/dio_helper/actions/put.dart' as _i71;
...
import 'package:flutter_tdd/core/http/dio_helper/utils/handle_request_body.dart'
    as _i48;
import 'package:flutter_tdd/core/http/generic_http/generic_http.dart' as _i41;
import 'package:flutter_tdd/core/network/network_info.dart' as _i50;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i39.Download>(() => _i39.Download());
    gh.lazySingleton<_i40.FirebaseAnalyticsHelper>(
        () => _i40.FirebaseAnalyticsHelper());
    gh.lazySingleton<_i41.GenericHttpImpl<dynamic>>(
        () => _i41.GenericHttpImpl<dynamic>());
    gh.lazySingleton<_i42.Get>(() => _i42.Get());
    gh.factory<_i43.GetDeviceId>(() => _i43.GetDeviceId());
    gh.lazySingleton<_i44.GlobalContext>(() => _i44.GlobalContext());
    gh.lazySingleton<_i45.GlobalNotification>(() => _i45.GlobalNotification());
    gh.lazySingleton<_i46.HandleErrors>(() => _i46.HandleErrors());
    gh.lazySingleton<_i47.HandleJsonResponse<dynamic>>(
        () => _i47.HandleJsonResponse<dynamic>());
    gh.lazySingleton<_i48.HandleRequestBody>(() => _i48.HandleRequestBody());
    gh.lazySingleton<_i49.LoadingHelper>(() => _i49.LoadingHelper());
    gh.lazySingleton<_i50.NetworkInfoImpl>(() => _i50.NetworkInfoImpl());
    gh.lazySingleton<_i51.NewVersionHelper>(() => _i51.NewVersionHelper());
    gh.factory<_i52.NotificationsDataSources>(
        () => _i53.ImplNotificationsDataSources());
    gh.factory<_i54.NotificationsRepository>(
        () => _i55.ImplNotificationsRepository());
    gh.lazySingleton<_i56.Patch>(() => _i56.Patch());
    gh.lazySingleton<_i57.Post>(() => _i57.Post());
    gh.factory<_i58.ProductsDataSource>(() => _i59.ImplProductsDataSource());
    gh.factory<_i60.ProductsHelper>(() => _i60.ProductsHelper());
    gh.factory<_i61.ProductsRepository>(() => _i62.ImplProductsRepository());
    gh.factory<_i63.ProfileDataSources>(() => _i64.ImplProfileDataSources());
    gh.factory<_i65.ProfileRepository>(() => _i66.ImplProfileRepository());
    gh.factory<_i67.PurchasingDataSources>(
        () => _i68.ImplPurchasingDataSources());
    gh.factory<_i69.PurchasingRepository>(
        () => _i70.ImplPurchasingRepository());
    gh.lazySingleton<_i71.Put>(() => _i71.Put());
    gh.lazySingleton<_i72.RateAppHelper>(() => _i72.RateAppHelper());
    gh.factory<_i73.SaleDataSources>(() => _i74.ImplSaleRepository());
    gh.factory<_i75.SaleRepository>(() => _i76.ImplSaleRepository());
    gh.factory<_i77.SearchDataSources>(() => _i78.ImplSearchDataSources());
    gh.factory<_i79.SearchRepository>(() => _i80.ImplSearchRepository());
    gh.factory<_i81.TicketsDataSources>(() => _i82.ImplTicketsDataSources());
    gh.factory<_i83.TicketsRepository>(() => _i84.ImplTicketsRepository());
    gh.lazySingleton<_i85.Utilities>(() => _i85.Utilities());
    gh.factory<_i86.WalletDataSources>(() => _i87.ImplWalletDataSources());
    gh.factory<_i88.WalletRepository>(() => _i89.ImplWalletRepository());
    gh.factory<_i90.WishlistDataSources>(() => _i91.ImplWishlistDataSources());
    gh.factory<_i92.WishlistRepository>(() => _i93.ImplWishlistRepository());
    return this;
  }
}
