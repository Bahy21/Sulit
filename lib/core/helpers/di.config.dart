...
import 'package:flutter_tdd/core/helpers/firebase_analytics_helper.dart'
    as _i39;
import 'package:flutter_tdd/core/helpers/get_device_id.dart' as _i42;
import 'package:flutter_tdd/core/helpers/global_context.dart' as _i43;
import 'package:flutter_tdd/core/helpers/global_notification.dart' as _i44;
import 'package:flutter_tdd/core/helpers/loading_helper.dart' as _i48;
import 'package:flutter_tdd/core/helpers/new_version_helper.dart' as _i50;
import 'package:flutter_tdd/core/helpers/rate_app_helper.dart' as _i71;
import 'package:flutter_tdd/core/helpers/utilities.dart' as _i84;
...
import 'package:flutter_tdd/core/http/dio_helper/actions/patch.dart' as _i55;
import 'package:flutter_tdd/core/http/dio_helper/actions/post.dart' as _i56;
import 'package:flutter_tdd/core/http/dio_helper/actions/put.dart' as _i70;
...
import 'package:flutter_tdd/core/network/network_info.dart' as _i49;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i42.GetDeviceId>(() => _i42.GetDeviceId());
    gh.lazySingleton<_i43.GlobalContext>(() => _i43.GlobalContext());
    gh.lazySingleton<_i44.GlobalNotification>(() => _i44.GlobalNotification());
    gh.lazySingleton<_i45.HandleErrors>(() => _i45.HandleErrors());
    gh.lazySingleton<_i46.HandleJsonResponse<dynamic>>(
        () => _i46.HandleJsonResponse<dynamic>());
    gh.lazySingleton<_i47.HandleRequestBody>(() => _i47.HandleRequestBody());
    gh.lazySingleton<_i48.LoadingHelper>(() => _i48.LoadingHelper());
    gh.lazySingleton<_i49.NetworkInfoImpl>(() => _i49.NetworkInfoImpl());
    gh.lazySingleton<_i50.NewVersionHelper>(() => _i50.NewVersionHelper());
    gh.factory<_i51.NotificationsDataSources>(
        () => _i52.ImplNotificationsDataSources());
    gh.factory<_i53.NotificationsRepository>(
        () => _i54.ImplNotificationsRepository());
    gh.lazySingleton<_i55.Patch>(() => _i55.Patch());
    gh.lazySingleton<_i56.Post>(() => _i56.Post());
    gh.factory<_i57.ProductsDataSource>(() => _i58.ImplProductsDataSource());
    gh.factory<_i59.ProductsHelper>(() => _i59.ProductsHelper());
    gh.factory<_i60.ProductsRepository>(() => _i61.ImplProductsRepository());
    gh.factory<_i62.ProfileDataSources>(() => _i63.ImplProfileDataSources());
    gh.factory<_i64.ProfileRepository>(() => _i65.ImplProfileRepository());
    gh.factory<_i66.PurchasingDataSources>(
        () => _i67.ImplPurchasingDataSources());
    gh.factory<_i68.PurchasingRepository>(
        () => _i69.ImplPurchasingRepository());
    gh.lazySingleton<_i70.Put>(() => _i70.Put());
    gh.lazySingleton<_i71.RateAppHelper>(() => _i71.RateAppHelper());
    gh.factory<_i72.SaleDataSources>(() => _i73.ImplSaleRepository());
    gh.factory<_i74.SaleRepository>(() => _i75.ImplSaleRepository());
    gh.factory<_i76.SearchDataSources>(() => _i77.ImplSearchDataSources());
    gh.factory<_i78.SearchRepository>(() => _i79.ImplSearchRepository());
    gh.factory<_i80.TicketsDataSources>(() => _i81.ImplTicketsDataSources());
    gh.factory<_i82.TicketsRepository>(() => _i83.ImplTicketsRepository());
    gh.lazySingleton<_i84.Utilities>(() => _i84.Utilities());
    gh.factory<_i85.WalletDataSources>(() => _i86.ImplWalletDataSources());
    gh.factory<_i87.WalletRepository>(() => _i88.ImplWalletRepository());
    gh.factory<_i89.WishlistDataSources>(() => _i90.ImplWishlistDataSources());
    gh.factory<_i91.WishlistRepository>(() => _i92.ImplWishlistRepository());
    return this;
  }
}
