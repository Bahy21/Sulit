...
class _$_ImageModel extends _ImageModel {
  const _$_ImageModel({required this.name, required this.url}) : super._();
  ...
  @override
  String toString() {
    return 'ImageModel(name: $name, url: $url)';
  }
...
abstract class _ImageModel extends ImageModel {
  const factory _ImageModel(
      {required final String name, required final String url}) = _$_ImageModel;
